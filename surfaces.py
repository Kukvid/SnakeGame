...
gameover_text = font_gameover.render("Конец игры", 1, "black")
welcome_text = font_welcome.render("Добро пожаловать в Змейку!",1, "green")
...
rules_text_3 = font_rules.render("Если вы врежетесь в себя или в стену, то змейка погибнеет!", 1, "black")
